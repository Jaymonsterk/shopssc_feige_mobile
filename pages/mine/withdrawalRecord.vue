<template>
    <view class="container">
        ...
        <view class="nav_wrap">
            ...
            <view class="title">{{i18n.hui_title}}</view>
        ...
        <view class="list_wrap">
        	<view class="list" v-for="(item,index) in list" :key='index'>
        		<view class="item">
        			<text class="new_type">{{item.realName}}</text>
        		...
        		<view class="item">
        			...
        			<text class="money_type">{{item.msg}}</text>
        		</view>
        	</view>
	...
	export default {
		...
		methods: {
            ...
            getWithdrawalList(){
                ...
                this.$tools.Post("dock/member/withdrawal/all",params).then((res) =>{
                    if(res.errCode == 0){
                        //这里只会在接口是成功状态返回
